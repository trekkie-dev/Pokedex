  ...
  for (const pokemon of pokemonArray) {
    try {
      ...
      listItem.style.backgroundColor =
        typeColors[primaryType] || 'var(--pokeball-red)';
      listItem.innerHTML = `
        ...
        <span class="favorite-icon material-icons-outlined" data-id="${pokemonID}">favorite_border</span>
      `;
...
function toggleFaves(pokemonID) {
